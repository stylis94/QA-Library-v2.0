...
import { ArrowLeft, Smartphone, Lightbulb, ListChecks, Settings, Zap } from 'lucide-react'
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <Alert>
                  ...
                  <AlertDescription>
                    <strong>{'Мобильное тестирование'}</strong>
                    {' - это процесс проверки программного обеспечения, разработанного для мобильных устройств.'}
                  </AlertDescription>
                </Alert>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <ul className="list-disc list-inside text-sm text-slate-600 dark:text-slate-300">
                      <li>
                        <strong>{'Нативные:'}</strong>{' Разработаны специально для конкретной платформы (iOS/Android).'}
                      </li>
                      <li>
                        <strong>{'Гибридные:'}</strong>{' Разработаны с использованием веб-технологий и обернуты в нативный контейнер.'}
                      </li>
                      <li>
                        <strong>{'Веб-приложения (Mobile Web):'}</strong>{' Сайты, оптимизированные для просмотра на мобильных устройствах через браузер.'}
                      </li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Проверка всех функций приложения на соответствие требованиям.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Оценка скорости, отзывчивости и стабильности приложения.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Проверка интуитивности, простоты и комфорта использования приложения.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Проверка работы приложения на различных устройствах, версиях ОС и разрешениях экрана.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Проверка поведения приложения при внешних событиях (звонки, SMS, переключение сети).'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Выявление уязвимостей и защита данных пользователя.'}
                    </p>
                  </CardContent>
                </Card>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Android - самая распространенная мобильная ОС с большим разнообразием устройств. Фрагментация, установка APK, ADB для логов.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'iOS - закрытая экосистема Apple с меньшей фрагментацией. Установка IPA через Xcode, симулятор, UDID.'}
                    </p>
                  </CardContent>
                </Card>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Официальная IDE для Android, включает эмулятор.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Официальная IDE для iOS, включает симулятор.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Утилита командной строки для взаимодействия с Android-устройством.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Кроссплатформенный фреймворк для автоматизации тестирования.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Платформы для тестирования на реальных устройствах в масштабе.'}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-slate-600 dark:text-slate-300">
                      {'Инструменты для перехвата и анализа HTTP/HTTPS трафика.'}
                    </p>
                  </CardContent>
                </Card>
              </CardContent>
