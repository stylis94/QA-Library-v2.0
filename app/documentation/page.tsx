...
import { ArrowLeft, Bug, CheckCircle, FileText, Lightbulb, ListChecks } from 'lucide-react'
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <Alert>
                  ...
                  <AlertDescription>
                    {'Тестовая документация нужна, чтобы процесс тестирования был '}
                    <strong>{'повторяемым, понятным и прозрачным'}</strong>
                    {' [^8].'}
                  </AlertDescription>
                </Alert>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-600 dark:text-slate-300">
                              {'Разработчики понимают, что сломалось.'}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-600 dark:text-slate-300">
                              {'Бизнес видит, что и как проверяется.'}
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          <TabsContent value="test-cases" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>{'Подробные сценарии проверки функциональности.'}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <Alert>
                  <Lightbulb className="h-4 w-4" />
                  <AlertDescription>
                    <strong>{'Тест-кейс'}</strong>
                    {' — это подробный сценарий проверки конкретной функции. Включает: Название, Предусловия, Шаги, Ожидаемый результат, Фактический результат (во время выполнения) [^8].'}
                  </AlertDescription>
                </Alert>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-600 dark:text-slate-300">
                            {'Каждый шаг должен быть четким и логичным.'}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-600 dark:text-slate-300">
                            {'Избегайте двусмысленности и избыточной информации [^8].'}
                          </p>
                        </div>
                      </div>
                      <div className="p-3 border rounded-lg">
          ...
          <TabsContent value="checklists" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>{'Списки проверок без подробных шагов.'}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <Alert>
                  <Lightbulb className="h-4 w-4" />
                  <AlertDescription>
                    ...
                    {' — это список проверок '}
                    <strong>{'без подробных шагов'}</strong>
                    {'. Удобно для быстрых проверок и smoke-тестов [^8].'}
                  </AlertDescription>
                </Alert>
                  ...
                  <CardContent className="space-y-4">
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm text-left text-slate-500 dark:text-slate-400">
                        ...
                        <tbody>
                          <tr className="bg-white border-b dark:bg-slate-8 00 dark:border-slate-700">
                            <td className="px-6 py-4">{'Много новых функций, тестируют все'}</td>
                            <td className="px-6 py-4">
                              <strong>{'Тест-кейсы'}</strong>
                              {' — чтобы ничего не забыть [^8]'}
                            </td>
                          </tr>
                          <tr className="bg-white border-b dark:bg-slate-800 dark:border-slate-700">
                            ...
                            <td className="px-6 py-4">
                              <strong>{'Чек-лист'}</strong>
                              {' — быстро и эффективно [^8]'}
                            </td>
                          </tr>
                          <tr className="bg-white dark:bg-slate-800">
                            <td className="px-6 py-4">
                              {'Нужно показать клиенту/менеджеру, что было проверено'}
                            </td>
                            <td className="px-6 py-4">
                              <strong>{'Чек-лист'}</strong>
                              {' или итог выполнения тестов [^8]'}
                            </td>
                          </tr>
                        </tbody>
                      </table>
          ...
          <TabsContent value="bug-reports" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>{'Как правильно описывать найденные дефекты.'}</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <Alert>
                  <Lightbulb className="h-4 w-4" />
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <ul className="list-disc list-inside text-sm text-slate-600 dark:text-slate-300">
                      <li>
                        <strong>{'Заголовок:'}</strong> {'Краткое и информативное описание проблемы.'}
                      </li>
                      <li>
                        <strong>{'Шаги воспроизведения:'}</strong>{' Четкие и последовательные шаги, которые приводят к дефекту [^8].'}
                      </li>
                      <li>
                        <strong>{'Ожидаемый результат:'}</strong>{' Как система должна была себя вести [^8].'}
                      </li>
                      <li>
                        <strong>{'Фактический результат:'}</strong>{' Как система повела себя на самом деле [^8].'}
                      </li>
                      <li>
                        <strong>{'Окружение:'}</strong>{' Браузер, ОС, версия приложения, устройство [^8].'}
                      </li>
                      <li>
                        <strong>{'Приоритет (Priority):'}</strong>{' Важность исправления дефекта с точки зрения бизнеса [^7].'}
                      </li>
                      <li>
                        <strong>{'Серьезность (Severity):'}</strong>{' Степень влияния дефекта на функциональность системы [^7].'}
                      </li>
                    </ul>
                  </CardContent>
                </Card>
